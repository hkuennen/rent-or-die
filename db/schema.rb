...
ActiveRecord::Schema[7.0].define(version: 2022_11_24_130814) do
  ...
  create_table "meetings", force: :cascade do |t|
    ...
    t.index ["survivalist_id"], name: "index_meetings_on_survivalist_id"
  ...
  add_foreign_key "meetings", "survivalists"
